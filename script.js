...
function toss(){
    ...
    if(turn <= 0.5){
        ...
        document.getElementById("player1Button").addEventListener('click',playerOne);
        document.getElementById("player1message").innerHTML = "player 1's turn";
        
    }else{
        
        document.getElementById("player2Button").addEventListener('click',playerTwo );
    ...
    function winner(){
        if (playerOneScore !== 0 && playerTwoScore !== 0) {
            ...
            if (playerOneScore > playerTwoScore) {
                ...
                document.getElementById("player1message").innerHTML = "Player 1 WON!....😍";
                document.getElementById("player1Button").disabled = true;
            }
            else{
                document.getElementById("player2message").innerHTML = "layer 2 WON!....😍";
                document.getElementById("player2Button").disabled = true;
            }
        }
